...
let ele12 = document.querySelector('#block-man');
darkModeIcon.onclick = () => {
    ...
    if(mode.getAttribute('class')=='dark'){
        ...
        ele12.setAttribute('colors' , "primary:#317773,secondary:#317773");
    }
    else{
        ...
        ele12.setAttribute('colors' , "primary:#ff7f11,secondary:#ff7f11");
    }
